...
_.extend(TAPi18n.prototype, {
  ...
  _loadLangFileObject: function(language_tag, data) {
    ...
    for (package_name in data) {
      ...
      _results.push(this.addResourceBundle(language_tag, package_name, package_keys));
    }
    return _results;
  },
...
_.extend(TAPi18n.prototype, {
  ...
  _registerAllServerTranslators: function() {
    var lang_tag, package_name, _i, _len, _ref, _results;
    _ref = this._getProjectLanguages();
    _results = [];
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      lang_tag = _ref[_i];
      _results.push((function() {
        ...
        for (package_name in this.translations[lang_tag]) {
          _results1.push(this._registerServerTranslator(lang_tag, package_name));
        }
        return _results1;
      }).call(this));
    }
